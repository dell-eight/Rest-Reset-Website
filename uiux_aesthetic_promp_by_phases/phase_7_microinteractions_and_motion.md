# Phase 7 — Microinteractions And Subtle Motion
...
Interaction Designer + Frontend Developer Agent
...
Add subtle, tasteful interactions that make the website feel more modern without hurting performance or accessibility.

## Copy-Paste Prompt For Codex

```text
You are implementing Phase 7 — Microinteractions And Subtle Motion.
...
Tasks:
1. Inspect existing components for buttons, cards, links, FAQ, product cards, and forms.
2. Add subtle hover/focus states to buttons and cards.
3. Improve active/focus states for accessibility.
4. Add smooth transitions where appropriate.
5. Add simple disclosure/accordion polish if FAQ already exists.
6. Do not add heavy animation libraries unless already installed.
7. Respect reduced motion preferences if adding motion.
8. Do not animate critical content in a distracting way.
9. Do not change form or checkout behavior.
10. Run build/lint/typecheck if available.
...
- Commands run
- Manual QA checklist
- PHASE 7 DONE or PHASE 7 NOT DONE
```

## Done Checklist

- Buttons feel interactive.
- Cards have tasteful hover/focus states.
- FAQ interactions are polished if applicable.
- Reduced motion is respected where relevant.
- No performance-heavy dependency added.
